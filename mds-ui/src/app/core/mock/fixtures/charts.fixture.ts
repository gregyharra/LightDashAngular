...
const revenueAreaConfig = normalizeChartConfig({
  type: 'cartesian',
  config: {
    layout: {
      cartesianKind: 'area',
...
const revenueScatterConfig = normalizeChartConfig({
  type: 'cartesian',
  config: {
    layout: {
      cartesianKind: 'scatter',
      xField: getFieldId('orders', 'order_date'),
      yFields: [getFieldId('orders', 'total_revenue')],
      flipAxes: false,
    },
...
const statusFunnelConfig = normalizeChartConfig({
  type: 'funnel',
  config: {
    fieldId: getFieldId('orders', 'order_count'),
    labelFieldId: getFieldId('orders', 'status'),
    dataInput: 'column',
    showLegend: true,
...
const revenueTreemapConfig = normalizeChartConfig({
  type: 'treemap',
  config: {
    dimensionFieldIds: [getFieldId('orders', 'status')],
    metricFieldId: getFieldId('orders', 'total_revenue'),
    showLegend: false,
    rowLimit: 500,
    margins: { top: 8, right: 8, bottom: 8, left: 8 },
  },
...
const orderCountGaugeConfig = normalizeChartConfig({
  type: 'gauge',
  config: {
    selectedField: getFieldId('orders', 'order_count'),
    showLabel: true,
...
const statusStoreSankeyConfig = normalizeChartConfig({
  type: 'sankey',
  config: {
    sourceFieldId: getFieldId('orders', 'status'),
    targetFieldId: getFieldId('orders', 'store_id'),
    weightFieldId: getFieldId('orders', 'order_count'),
    showNodeLabels: true,
    rowLimit: 500,
    margins: { top: 8, right: 8, bottom: 8, left: 8 },
  },
...
export const mockSavedChartDetails: Record<string, SavedChart> = {
  ...
  [MOCK_CHART_9_UUID]: {
    uuid: MOCK_CHART_9_UUID,
    name: 'Revenue area',
    description: 'Area chart of revenue by month',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    ...
    pinnedListOrder: null,
    views: 4,
    firstViewedAt: '2024-04-01T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'area',
    tableName: 'orders',
    metricQuery: revenueByMonthQuery,
    chartConfig: revenueAreaConfig,
    updatedByUser: {
      userUuid: MOCK_USER_UUID,
      firstName: 'Demo',
      lastName: 'Analyst',
  ...
  [MOCK_CHART_10_UUID]: {
    uuid: MOCK_CHART_10_UUID,
    name: 'Partner profit scatter',
    description: 'Scatter of revenue over time',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    ...
    pinnedListOrder: null,
    views: 3,
    firstViewedAt: '2024-04-02T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'scatter',
    tableName: 'orders',
  ...
  [MOCK_CHART_12_UUID]: {
    uuid: MOCK_CHART_12_UUID,
    name: 'Status funnel',
    description: 'Order count funnel by status',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    updatedAt: '2024-06-03T13:00:00.000Z',
    pinnedListUuid: null,
    pinnedListOrder: null,
    views: 6,
    firstViewedAt: '2024-04-04T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'funnel',
    tableName: 'orders',
    metricQuery: statusBreakdownQuery,
    chartConfig: statusFunnelConfig,
    updatedByUser: {
      userUuid: MOCK_USER_UUID,
      firstName: 'Demo',
      lastName: 'Analyst',
  ...
  [MOCK_CHART_13_UUID]: {
    uuid: MOCK_CHART_13_UUID,
    name: 'Revenue treemap',
    description: 'Revenue share by status',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    updatedAt: '2024-06-03T14:00:00.000Z',
    pinnedListUuid: null,
    pinnedListOrder: null,
    views: 4,
    firstViewedAt: '2024-04-05T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'treemap',
    tableName: 'orders',
    metricQuery: statusBreakdownQuery,
    chartConfig: revenueTreemapConfig,
    updatedByUser: {
      userUuid: MOCK_USER_UUID,
      firstName: 'Demo',
      lastName: 'Analyst',
  ...
  [MOCK_CHART_14_UUID]: {
    uuid: MOCK_CHART_14_UUID,
    name: 'Order count gauge',
    description: 'Big gauge for order volume',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    updatedAt: '2024-06-03T15:00:00.000Z',
    pinnedListUuid: null,
    pinnedListOrder: null,
    views: 8,
    firstViewedAt: '2024-04-06T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'gauge',
    tableName: 'orders',
    ...
    chartConfig: orderCountGaugeConfig,
    updatedByUser: {
      userUuid: MOCK_USER_UUID,
      firstName: 'Demo',
      lastName: 'Analyst',
  ...
  [MOCK_CHART_15_UUID]: {
    uuid: MOCK_CHART_15_UUID,
    name: 'Status to store flow',
    description: 'Sankey from status to store',
    spaceUuid: MOCK_SPACE_UUID,
    spaceName: 'Shared',
    projectUuid: MOCK_PROJECT_UUID,
    updatedAt: '2024-06-03T16:00:00.000Z',
    pinnedListUuid: null,
    pinnedListOrder: null,
    views: 2,
    firstViewedAt: '2024-04-07T10:00:00.000Z',
    isPrivate: false,
    access: [],
    chartKind: 'sankey',
    tableName: 'orders',
    metricQuery: statusStoreQuery,
    chartConfig: statusStoreSankeyConfig,
    updatedByUser: {
      userUuid: MOCK_USER_UUID,
      firstName: 'Demo',
      lastName: 'Analyst',
