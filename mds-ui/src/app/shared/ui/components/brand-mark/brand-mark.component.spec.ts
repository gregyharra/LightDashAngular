...
import { DpfBrandMarkComponent } from './brand-mark.component';

describe('DpfBrandMarkComponent', () => {
  let fixture: ComponentFixture<DpfBrandMarkComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DpfBrandMarkComponent],
      providers: [provideRouter([])],
    }).compileComponents();
    fixture = TestBed.createComponent(DpfBrandMarkComponent);
  ...
  it('renders the mark and wordmark text', () => {
    ...
    const wordmark = host.querySelector('.dpf-brand-mark__wordmark') as HTMLElement;
